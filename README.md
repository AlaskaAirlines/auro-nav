...
The `<auro-nav>` element acts as a container for a series of `<auro-hyperlinks>`. The `<auro-nav>` element should only be used for multi-page projects that have 3 to 5 levels of page depth.
