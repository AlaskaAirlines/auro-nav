...
[![Build Status](https://img.shields.io/github/workflow/status/AlaskaAirlines/auro-nav/Test%20and%20publish?branch=master&style=for-the-badge)](https://github.com/AlaskaAirlines/auro-nav/actions?query=workflow%3A%22test+and+publish%22)
...
In cases where the project is not able to process JS assets, there are pre-processed assets available for use. Two bundles are available -- `auro-nav__bundled.js` for modern browsers and `auro-nav__bundled.es5.js` for legacy browsers (including IE11).
...
<script src="https://unpkg.com/@aurodesignsystem/auro-nav@latest/dist/auro-nav__bundled.js" type="module"></script>
<script src="https://unpkg.com/@aurodesignsystem/auro-nav@latest/dist/auro-nav__bundled.es5.js" nomodule></script>
```
